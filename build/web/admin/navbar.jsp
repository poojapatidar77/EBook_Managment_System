       ...
       <div class="col-md-6">
        ...
        <div class="col-md-3">
          ...
          <a  class="btn btn-success">
              ...
              ${userobj.name}</a>
           <a data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-primary ml-1">
          ...
          <a href="../register.jsp" class="btn btn-primary ml-1"><i class="fa-solid fa-user-plus"></i> Register</a>
          </c:if>
       </div>
